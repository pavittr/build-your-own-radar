const ExceptionMessages = {
  ...
  'Check that your document contains headers for "name", "ring", "quadrant", "capability", "description".',
  ...
  JSON_DATA_NOT_FOUND: 'Oops! Looks like we can’t find the data source. Check the connection?'
};
